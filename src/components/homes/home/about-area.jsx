...
const about_info = {
  ...
  about_title: 'New About Our Courses',
  sub_title: 'Discover Exciting New Classes.',
  des: (
    <>
      Deliver innovative and engaging content to inspire creativity. Explore our
      latest courses and unleash your potential.
    </>
  ),
