                ...
                <div className="course-details-content mb-45">
                  ...
                  <div className="tpcourse__ava-title mb-25">
                    <h4 className="c-details-title">
                      <a href="#">
                        Master Web Design in Adobe XD: Comprehensive training in
                        UI/UX Masterclass
                      </a>
                    </h4>
                  </div>
                    ...
                    <ul className="d-flex align-items-center">
                      ...
                      <li>
                        <img
                          ...
                          alt="meta-icon"
                        />{' '}
                        <span>292 Students</span>
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="c-details-about mb-40">
                  <h5 className="tp-c-details-title mb-20">Course Overview</h5>
                  <p>
                    Harmoniously cultivate round-the-clock guidance rather than
                    expandable platforms. Conveniently depict established
                    foundation merchandise prior to interactive outcomes.
                    Collaboratively reinstate corporate encounters and publicly
                    available software. Proactively integrate collaborative
                    expansion tactics for shared prospects. Competently generate
                    effective markets through top-notch potentialities.
                  </p>
                  <p>
                    Proactively commence corporate portals through
                    bricks-and-clicks partnerships. Dynamically conceive
                    innovative frameworks through customer-centric
                    relationships. Internationally repurpose backward-compatible
                    expansion strategies and thoroughly validated electronic
                    services. Enthusiastically advocate independent models while
                    delivering efficient solutions. Rapidly focus on low-risk
                    high-return e-markets through internet-enabled networks.
                  </p>
                </div>
                <div className="cor-details-instructor mb-40">
                  ...
                  <div className="course-instructor-details d-flex f-wrap align-items-center">
                    ...
                    <div className="course-avatar-details mb-20">
                      ...
                      <p>
                        Gain proficiency in Chemical & User Interface Design
                        Education that has been acknowledged with accolades
                      </p>
                  ...
                  <p>
                    Foster leadership 24/7 in a harmonious way instead of
                    relying on scalable platforms. Effortlessly visualize
                    current product installations before achieving dynamic
                    results. Collaboratively rejuvenate corporate experiences
                    and open-source applications. Proactively incorporate
                    cooperative strategies for fostering growth.
                  </p>
                </div>
